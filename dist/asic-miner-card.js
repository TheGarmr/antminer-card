 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function pt(t){return(e,s)=>"object"==typeof s?dt(t,e,s):((t,e,s)=>{const i=e.hasOwnProperty(s);return e.constructor.createProperty(s,t),i?Object.getOwnPropertyDescriptor(e,s):void 0})(t,e,s)}const ut="asic-miner-card-editor",mt="asic-miner-card";var ft;!function(t){t.hashrate="hashrate",t.ideal_hashrate="ideal_hashrate",t.temperature="temperature",t.miner_consumption="miner_consumption",t.power_limit="power_limit",t.efficiency="efficiency",t.active_preset_name="active_preset_name",t.active="active"}(ft||(ft={}));var gt={title:"ASIC Miner Card",description:"A Home Assistant card for ASIC miners (hass-miner integration)",version:"Version"},_t={language:"Language",title:"Title",prefix:"Sensor prefix",minerName:"Miner name",model:"Model (override)",deviceId:"Device ID (optional)",webUrl:"Web UI URL (override)",powerSwitch:"Power switch / breaker (optional)",decimals:"Hashrate decimals",tempWarn:"Temp. warning (°C)",tempCrit:"Temp. critical (°C)",boardCount:"Hashboards (0 = auto)",fanCount:"Fans (0 = auto)",titleAction:"Title click action",manualAssignment:"Manual entity assignment",titleShowHide:"Show / Hide zones",showTitle:"Title",showButtons:"Buttons",showMain:"Main",showFans:"Fans",showBoards:"Boards",showCardVersion:"Version",hashrate:"Hashrate entity",ideal_hashrate:"Ideal hashrate entity",temperature:"Temperature entity",miner_consumption:"Power consumption entity",power_limit:"Power limit entity",efficiency:"Efficiency entity",active_preset_name:"Active preset entity",active:"Mining switch entity",device_id:"Device ID"},$t={mining:"Mining",pause:"Pause",resume:"Resume",power:"Power",powerOn:"Power on",webui:"Web UI"},bt={hashrate:"Hashrate:",idealHashrate:"Ideal:",temperature:"Temperature:",power:"Power:",powerLimit:"Power limit:",efficiency:"Efficiency:",preset:"Preset:",fan:"Fan",board:"Board",chip:"Chip:",boardTemp:"Board:"},vt={mining:"MINING",stopped:"STOPPED",offline:"OFFLINE",unknown:"UNKNOWN"},wt={boards:"Hashboards",fans:"Fans",firmware:"FW",offlineNote:"The breaker is off — the miner is not powered"},yt={common:gt,config:_t,buttons:$t,stats:bt,status:vt,html_texts:wt},At={title:"Карточка ASIC-майнера",description:"Карточка Home Assistant для ASIC-майнеров (интеграция hass-miner)",version:"Версия"},St={language:"Язык",title:"Заголовок",prefix:"Префикс сенсоров",minerName:"Имя майнера",model:"Модель (вручную)",deviceId:"ID устройства (опционально)",webUrl:"URL веб-интерфейса (вручную)",powerSwitch:"Выключатель питания / автомат (опционально)",decimals:"Знаков после запятой (хешрейт)",tempWarn:"Темп. предупреждение (°C)",tempCrit:"Темп. критическая (°C)",boardCount:"Хешборды (0 = авто)",fanCount:"Кулеры (0 = авто)",titleAction:"Действие по клику на заголовок",manualAssignment:"Ручное назначение сущностей",titleShowHide:"Показать / Скрыть зоны",showTitle:"Заголовок",showButtons:"Кнопки",showMain:"Основное",showFans:"Кулеры",showBoards:"Платы",showCardVersion:"Версия",hashrate:"Сущность хешрейта",ideal_hashrate:"Сущность идеального хешрейта",temperature:"Сущность температуры",miner_consumption:"Сущность потребления",power_limit:"Сущность лимита мощности",efficiency:"Сущность эффективности",active_preset_name:"Сущность активного пресета",active:"Переключатель майнинга",device_id:"ID устройства"},xt={mining:"Майнит",pause:"Пауза",resume:"Старт",power:"Питание",powerOn:"Включить питание",webui:"Веб-интерфейс"},Ct={hashrate:"Хешрейт:",idealHashrate:"Идеальный:",temperature:"Температура:",power:"Мощность:",powerLimit:"Лимит:",efficiency:"Эффективность:",preset:"Пресет:",fan:"Кулер",board:"Плата",chip:"Чип:",boardTemp:"Плата:"},Et={mining:"МАЙНИНГ",stopped:"ОСТАНОВЛЕН",offline:"ОФФЛАЙН",unknown:"НЕИЗВЕСТНО"},kt={boards:"Хешборды",fans:"Кулеры",firmware:"Прошивка",offlineNote:"Автомат выключен — питание на майнер не подаётся"},Pt={common:At,config:St,buttons:xt,stats:Ct,status:Et,html_texts:kt},Nt={title:"Картка ASIC-майнера",description:"Картка Home Assistant для ASIC-майнерів (інтеграція hass-miner)",version:"Версія"},Ut={language:"Мова",title:"Заголовок",prefix:"Префікс сенсорів",minerName:"Ім'я майнера",model:"Модель (вручну)",deviceId:"ID пристрою (опційно)",webUrl:"URL веб-інтерфейсу (вручну)",powerSwitch:"Вимикач живлення / автомат (опційно)",decimals:"Знаків після коми (хешрейт)",tempWarn:"Темп. попередження (°C)",tempCrit:"Темп. критична (°C)",boardCount:"Хешборди (0 = авто)",fanCount:"Кулери (0 = авто)",titleAction:"Дія при кліку на заголовок",manualAssignment:"Ручне призначення сутностей",titleShowHide:"Показати / Сховати зони",showTitle:"Заголовок",showButtons:"Кнопки",showMain:"Основне",showFans:"Кулери",showBoards:"Плати",showCardVersion:"Версія",hashrate:"Сутність хешрейту",ideal_hashrate:"Сутність ідеального хешрейту",temperature:"Сутність температури",miner_consumption:"Сутність споживання",power_limit:"Сутність ліміту потужності",efficiency:"Сутність ефективності",active_preset_name:"Сутність активного пресету",active:"Перемикач майнінгу",device_id:"ID пристрою"},Ot={mining:"Майніт",pause:"Пауза",resume:"Старт",power:"Живлення",powerOn:"Увімкнути живлення",webui:"Веб-інтерфейс"},Tt={hashrate:"Хешрейт:",idealHashrate:"Ідеальний:",temperature:"Температура:",power:"Потужність:",powerLimit:"Ліміт:",efficiency:"Ефективність:",preset:"Пресет:",fan:"Кулер",board:"Плата",chip:"Чип:",boardTemp:"Плата:"},Mt={mining:"МАЙНІНГ",stopped:"ЗУПИНЕНО",offline:"ОФЛАЙН",unknown:"НЕВІДОМО"},Ht={boards:"Хешборди",fans:"Кулери",firmware:"Прошивка",offlineNote:"Автомат вимкнено — живлення на майнер не подається"},It={common:Nt,config:Ut,buttons:Ot,stats:Tt,status:Mt,html_texts:Ht};const Bt={hass:null},Rt={en:Object.freeze({__proto__:null,buttons:$t,common:gt,config:_t,default:yt,html_texts:wt,stats:bt,status:vt}),ru:Object.freeze({__proto__:null,buttons:xt,common:At,config:St,default:Pt,html_texts:kt,stats:Ct,status:Et}),uk:Object.freeze({__proto__:null,buttons:Ot,common:Nt,config:Ut,default:It,html_texts:Ht,stats:Tt,status:Mt})};function zt(t,e="",s=""){try{const i=Bt.cardConfig?.language;let n=localStorage.getItem("selectedLanguage");null===n&&(n=localStorage.getItem("editor-language")),null===n&&(n="en"),n=n.replace(/['"]+/g,"").replace("-","_");const o=Bt.hass?.selectedLanguage||Bt.hass?.locale?.language||Bt.hass?.language,r=i&&"auto"!==i?i:o||n;let a;try{a=t?.split(".").reduce((t,e)=>t[e],Rt[r])}catch(e){a=t?.split(".")?.reduce((t,e)=>t[e],Rt.en)}return void 0===a&&(a=t?.split(".")?.reduce((t,e)=>t[e],Rt.en)),""!==e&&""!==s&&(a=a.replace(e,s)),a}catch(e){return t}}var jt,Lt,Dt="1.0.0";!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(jt||(jt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(Lt||(Lt={}));var Ft=function(t,e,s){void 0===s&&(s=!1),s?history.replaceState(null,"",e):history.pushState(null,"",e),function(t,e,s,i){i=i||{},s=null==s?{}:s;var n=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});n.detail=s,t.dispatchEvent(n)}(window,"location-changed",{replace:s})};const Wt=(t,e,s)=>`${s}.${t?.prefix}_${e}`,Vt=(t,e,s)=>{const i=t?.entities?.[e]?.toString()?.trim(),n=Wt(t,e,s),o=i&&i.length>1?[(r=i,r.includes(".")?i:Wt(t,i,s)),n]:[n];var r;return[...new Set(o)]},qt=(t,e,s,i="sensor")=>{for(const n of Vt(e,s,i)){const e=t?.states[n];if(e)return{...e,entity_id:n}}return null};function Jt(t,e,s,i){i=i||{},s=null==s?{}:s;const n=new Event(e,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return n.detail=s,t.dispatchEvent(n),n}const Kt=(t,e,s,i="sensor",n)=>{if(!t)return;t.stopPropagation();const o=n?qt(n,e,s,i):null,r=o?.entity_id??Vt(e,s,i)[0],a=new CustomEvent("hass-more-info",{detail:{entityId:r},composed:!0});t.target.dispatchEvent(a)},Gt=(t,e)=>{const s=e?.deviceId?.trim()||e?.entities?.device_id?.toString()?.trim();if(s)return s;for(const s of["hashrate","temperature","miner_consumption"]){const i=qt(t,e,s);if(!i)continue;const n=t?.entities?.[i.entity_id]?.device_id;if(n)return n}},Zt=(t,e)=>{const s=Gt(t,e);return s?t?.devices?.[s]:void 0},Qt=(t,e)=>{const s=e?.webUrl?.trim();return s||(Zt(t,e)?.configuration_url??void 0)};let Xt=class extends at{constructor(){super(...arguments),this.VERSION=Dt}_navigate(t,e,s="sensor"){Kt(t,this.config,e,s,this.hass)}_navigateTitle(t){((t,e,s)=>{if("device"!==s?.titleAction)return void Kt(t,s,"hashrate","sensor",e);t?.stopPropagation();const i=Gt(e,s);i?Ft(0,`/config/devices/device/${i}`):Kt(t,s,"hashrate","sensor",e)})(t,this.hass,this.config)}getState(t,e=2,s="",i="sensor"){return((t,e,s,i=2,n="",o="sensor")=>{const r=qt(t,e,s,o);if(!r)return n;const a=r.state;if("unknown"===a||"unavailable"===a)return n;const c=Number(a);return isNaN(c)?a??n:c.toFixed(i)})(this.hass,this.config,t,e,s,i)}getUnit(t){return((t,e,s,i="sensor")=>{const n=qt(t,e,s,i);return n?.attributes?.unit_of_measurement??""})(this.hass,this.config,t)}detectCount(t){const e="board"===t?this.config.boardCount:this.config.fanCount;if(e&&e>0)return e;let s=0;for(let e=0;e<8;e++){const i="board"===t?`board_${e}_board_temperature`:`fan_${e}_fan_speed`;qt(this.hass,this.config,i)&&(s=e+1)}return s}_openWebUi(t){t?.stopPropagation();const e=Qt(this.hass,this.config);e&&window.open(e,"_blank")}_tempClass(t){if(isNaN(t))return"";const e=this.config.tempWarn??85;return t>=(this.config.tempCrit??95)?"temp-crit":t>=e?"temp-warn":"temp-ok"}_powerEntityId(){const t=this.config.powerSwitch?.toString()?.trim();return t?t.includes(".")?t:`switch.${t}`:null}_powerState(){const t=this._powerEntityId();return t?this.hass?.states[t]?.state??null:null}_togglePower(t){t?.stopPropagation();const e=this._powerEntityId();e&&this.hass.callService("homeassistant","toggle",{entity_id:e})}_renderPowerButton(){const t=this._powerEntityId();if(!t)return F``;const e=this._powerState();return F`
        ...
        `:F``}_renderFans(){const t=this.detectCount("fan");if(!t)return F``;const e=[];for(let s=0;s<t;s++){const t=`fan_${s}_fan_speed`,i=this.getState(t,0,"-"),n=this.getUnit(t)||"RPM";e.push(F`
                <div class="data-row">
    ...
    `,t([pt()],Xt.prototype,"hass",void 0),t([pt()],Xt.prototype,"config",void 0),Xt=t([lt("asic-miner-default-layout")],Xt);const te=Dt;console.groupCollapsed(`%c⛏️ ASIC Miner Card%c   ready!  🚀 (v${te})`,"background: linear-gradient(to right, #ffc107, #42a5f5); color: black; font-weight: bold; padding: 2px 8px; border-radius: 6px;","background: none; color: #AAA; font-style: italic;"),console.groupEnd();let ee=Yt=class extends at{setConfig(t){this._config=Yt.getStubConfig(),this._config={...this._config,...t},Bt.cardConfig=this._config}static getStubConfig(){return{language:"auto",title:"",prefix:"miner",minerName:"",model:"",webUrl:"",powerSwitch:"",decimals:2,tempWarn:85,tempCrit:95,boardCount:0,fanCount:0,titleAction:"device",showTitle:!0,showButtons:!0,showMain:!0,showFans:!0,showBoards:!0,showCardVersion:!1,entities:Object.keys(ft).reduce((t,e)=>(t[e]="",t),{})}}static async getConfigElement(){return await Promise.resolve().then(function(){return ie}),document.createElement(ut)}getCardSize(){return 4}getGridOptions(){return{columns:12,min_columns:6}}render(){return Bt.hass=this.hass,this.hass&&this._config?F`
        ...
        `}_valueChanged(t){const e={...this._config};Object.assign(e,t.detail.value),this._config=e,Jt(this,"config-changed",{config:this._config})}};t([pt()],se.prototype,"hass",void 0),t([pt()],se.prototype,"_config",void 0),t([pt()],se.prototype,"lovelace",void 0),se=t([lt(ut)],se);var ie=Object.freeze({__proto__:null,get AsicMinerCardEditor(){return se}});export{ee as AsicMinerCard,te as CARD_VERSION};
